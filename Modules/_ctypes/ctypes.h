...
#define CThunk_CheckExact(v)        (Py_TP(v) == &PyCThunk_Type)
...
#define PyCStgDict_CheckExact(v)            (Py_TP(v) == &PyCStgDict_Type)
...
#define CDataObject_CheckExact(v)       (Py_TP(v) == &PyCData_Type)
#define CDataObject_Check(v)            PyObject_TypeCheck(v, &PyCData_Type)
#define _CDataObject_HasExternalBuffer(v)  ((v)->b_ptr != (char *)&(v)->b_value)

extern PyTypeObject PyCSimpleType_Type;
#define PyCSimpleTypeObject_CheckExact(v)       (Py_TP(v) == &PyCSimpleType_Type)
...
#define PyCArg_CheckExact(v)        (Py_TP(v) == &PyCArg_Type)
