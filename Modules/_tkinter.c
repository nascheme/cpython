...
#define PyTclObject_Check(v) (Py_TP((v)) == (PyTypeObject *) PyTclObject_Type)
...
asBignumObj(PyObject *value)
{
    ...
    neg = _PyLong_NumDigits((PyLongObject *)value) < 0;
...
/*[clinic end generated code: output=726a9ae445821d91 input=7f11248ef8f8776e]*/
{
    ...
    if (PyLong_Check(arg)) { /* int or bool */
        return PyBool_FromLong(_PyLong_NumDigits((PyLongObject *)arg) != 0);
    }
