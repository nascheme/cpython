static void *opcode_targets[256] = {
    ...
    &&TARGET_BUILD_SLICE2_REG,
    &&TARGET_BUILD_LIST_REG,
    &&TARGET_UNPACK_SEQUENCE_REG,
    ...
    &&TARGET_STORE_MAP_REG,
    &&TARGET_MAKE_FUNCTION_REG,
    &&TARGET_LOAD_BUILD_CLASS_REG,
    &&TARGET_CALL_PROCEDURE_REG,
    &&TARGET_CLEAR_REG,
    &&TARGET_MAKE_CLOSURE_REG,
    &&TARGET_LOAD_CLOSURE_REG,
    &&TARGET_STORE_DEREF_REG,
    &&TARGET_DELETE_SUBSCR_REG,
    &&TARGET_LOAD_DEREF_REG,
    &&TARGET_BINARY_MODULO_REG,
    &&TARGET_STORE_SUBSCR_REG,
    &&TARGET_BINARY_TRUE_DIVIDE_REG,
    &&TARGET_INPLACE_TRUE_DIVIDE_REG,
    &&TARGET_INPLACE_MODULO_REG,
    &&TARGET_LOAD_NAME_REG,
    &&TARGET_LIST_APPEND_REG,
    &&TARGET_STORE_NAME_REG,
    &&TARGET_IMPORT_NAME_REG,
    &&TARGET_IMPORT_FROM_REG,
    &&TARGET_IMPORT_STAR_REG,
    &&TARGET_YIELD_REG,
    &&TARGET_STORE_LOCALS_REG,
    &&TARGET_UNARY_POSITIVE_REG,
    &&TARGET_MAP_ADD_REG,
    &&TARGET_BUILD_SLICE3_REG,
    &&TARGET_UNPACK_EX_REG,
    &&_unknown_opcode,
    &&_unknown_opcode,
    &&_unknown_opcode,
    &&_unknown_opcode,
